...
const PatientNavbar = ({ currentPage, onNavigate }: PatientNavbarProps) => {
  ...
  return (
    <nav className="sticky top-0 z-40 flex justify-between items-center px-8 py-4 bg-[#F0F7FF] dark:bg-slate-950 font-['Plus_Jakarta_Sans',_sans-serif] transition-colors duration-300">
      {/* Left: Logo */}
      <button 
        className="flex items-center gap-3 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#3B82F6] rounded-xl p-1" 
