        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-12 mb-12 md:mb-16">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl sm:text-2xl font-extrabold text-[#1a2b3c] dark:text-white tracking-tight">BoneScan AI</span>
            </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 sm:gap-4 text-slate-500 dark:text-slate-400">
